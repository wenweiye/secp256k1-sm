...
typedef struct {
    ...
    unsigned char msg[32];
    unsigned char key[32];
    unsigned char keyInv[32];
    unsigned char keyInvkey[32];
} bench_sm2_sign_data;
...
static void bench_sm2_sign_setup(void* arg) {
    int i;
    bench_sm2_sign_data *data = (bench_sm2_sign_data*)arg;
...
static void bench_sm2_sign_run(void* arg, int iters) {
    int i;
    bench_sm2_sign_data *data = (bench_sm2_sign_data*)arg;
